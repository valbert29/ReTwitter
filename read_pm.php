                                    ...
                                    <div class="row">
                                        <daiv class="col-md-12 ml-auto mr-auto">
                                            <div class="card1" style="padding: 3% 5% 5% 5%; text-align: center">
                                                    ...
                                                    while($dn2 = pg_fetch_array($req2))
                                                    {
                                                        ...
                                                        <tr>
                                                            <td style="width: 25%;"><?php
                                                                if($dn2['photo']!='')
                                                                {
                                                                    echo '<img src="'.htmlentities($dn2['photo']).'" alt="Image Perso" style="max-width:100px;max-height:100px;" />';
                                                                }
                                                ...
                                                <form class="form-group" action="read_pm.php?id=<?php echo $id; ?>" method="GET">
